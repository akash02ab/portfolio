const rawJobData = [
	{
		...
		url: "https://magureinc.com/",
		control: ["I make websites go brrr..."],
	},
	{
		title: "FrontEnd Engineer",
		company: "Web Olympus",
		range: "Apr 2024 - Sept 2024",
		url: "https://web-olympus.com/",
		control: [
			"Developed dynamic, responsive, and accessible user interfaces using React and modern web development practices.",
			"Integrated component libraries (e.g., Material UI, Tailwind CSS, or custom styles) for consistent and visually appealing designs.",
		],
	},
	{
		title: "FrontEnd Engineer",
